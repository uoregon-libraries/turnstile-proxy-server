...
func help() {
	...
	fmt.Println(`- LOG_RETENTION (optional): how long to keep logged events, as a Go duration ("48h").`)
	fmt.Println(`                 Defaults to "48h" (30 days). "0" keeps events forever (no pruning).`)
